<%-- 
    Document   : home
    Created on : Feb 21, 2023, 8:30:31 PM
    Author     : Admin
--%>
    ...
    <body>
        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-light">
            <div class="container px-4 px-lg-5">
                <a class="navbar-brand" href="home.jsp">Shop Car</a>
        ...
        <header class="bg-dark py-5">
            ...
            <div class="container px-4 px-lg-5 my-5">
                ...
                <div class="text-center text-white">
                    <h1 class="display-4 fw-bolder">Shop Car</h1>
                    <p class="lead fw-normal text-white-50 mb-0">"Leave the car to us, you just focus on the payment"</p>
                </div>
            </div>
        </header>
